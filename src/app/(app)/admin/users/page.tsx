...
import { Plus, Shield, Upload, User, UserCog, Users } from "lucide-react";
...
async function getUserStats() {
  ...
  return {
    ...
    employees: allUsers.filter((u) => u.assignedRole?.name === "employee")
      .length,
    supervisors: allUsers.filter((u) => u.assignedRole?.name === "supervisor")
      .length,
