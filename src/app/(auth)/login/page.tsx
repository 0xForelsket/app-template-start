  ...
  const demoAccounts =
    process.env.NEXT_PUBLIC_SHOW_DEMO_ACCOUNTS === "true"
      ? [
          ...
          { role: "Supervisor", id: "SUP-001", pin: "567890" },
          { role: "Employee", id: "EMP-001", pin: "000000" },
        ]
      : [];
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-zinc-950 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-16 text-white">
          <div className="mb-8">
            ...
            <h1 className="text-4xl xl:text-5xl font-bold mb-4">Factory App</h1>
            <p className="text-xl text-zinc-400 max-w-md">
              A modern template for building powerful industrial applications.
            </p>
          </div>
          ...
          <div className="space-y-6 mt-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-zinc-400 text-sm">
                  Track and manage factory projects efficiently
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-lg">Real-time Auditing</h3>
                <p className="text-zinc-400 text-sm">
                  Full visibility into system changes and user actions
                </p>
              </div>
            </div>
          </div>
