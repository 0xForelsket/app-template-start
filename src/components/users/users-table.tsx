...
import { Edit, Shield, User, UserCog } from "lucide-react";
...
export function UsersTable({ users, searchParams }: UsersTableProps) {
  const columns: ColumnDef<UserWithRole>[] = [
    ...
    },
    {
      ...
      sortable: true,
      cell: (row) => {
        const roleName = row.assignedRole?.name || "employee";
        const roleConfig = roleConfigs[roleName] || roleConfigs.employee;
